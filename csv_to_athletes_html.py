        ...
        for filename in files:
            if filename.endswith(".html"):
                ...
                if "womens_team" in subdir:
                    link = f'<a href="../{relative_path}">{filename}</a>'
...
def main():
    ...
    for file in csv_file_names:
        ...
        gen_athlete_page(athlete_data, "mens_team/"+file.replace(".csv", ".html"), nav_html)
    ...
    for file in csv_file_names:
        ...
        gen_athlete_page(athlete_data, "womens_team/"+file.replace(".csv", ".html"), nav_html)
